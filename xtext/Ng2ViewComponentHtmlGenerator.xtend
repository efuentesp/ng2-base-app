...
import com.softtek.codegen.entity.View
						...
						<div class="row">
							...
							«IF view.add_link != null»
								<div class="col-md-6 text-right">
									<a [routerLink]="['Add«view.base_entity.name.toFirstUpper»']" class="btn btn-primary btn-create">Create New</a>
								</div>
							«ENDIF»
						</div>
					</div> <!-- panel-heading -->
									...
									«IF view.show_link != null || view.edit_link != null || view.delete_link  != null»
										<td>
											...
											«IF view.edit_link != null»
												<a [routerLink]="['Edit«view.base_entity.name.toFirstUpper»', {id: item.id}]" class="btn btn-sm btn-success">Edit</a>
											«ENDIF»
